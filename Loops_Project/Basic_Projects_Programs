...
int middle(int a, int b, int c) {
    ...
    if (a != maximum && a != minimum)return a;
    if (b != maximum && b != minimum)return b;
...
void prime() {
    ...
    if (flag)cout << "It is not a prime number " << endl;
...
void composite() {
    ...
    if (count > 1)cout << "It is a composite number " << endl;
    else cout << "it is not a composite number" << endl;
...
void RockPaperScissors() {
    ...
    for (int i = 0; i < matches; i++) {
        ...
        else if ((p1 == 'R' && p2 == 'S') || (p2 == 'R' && p1 == 'P') || (p2 == 'R' && p1 == 'P')) {
            cout << "match winner player 1" << endl;
            count1++;
        }
        else if ((p2 == 'R' && p1 == 'S') || (p1 == 'R' && p2 == 'P') || (p1 == 'R' && p2 == 'P')) {
